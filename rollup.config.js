...
module.exports = [
    ...
    createLibConfig(path.join(__dirname, "./src/datatable/index.js"), "datatable"),
    createLibConfig(path.join(__dirname, "./src/editor/index.js"), "editor"),
    createLibConfig(path.join(__dirname, "./src/widgets/index.js"), "widgets")
];
